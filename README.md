...
dao 是一个智能体应用，暂定为cli命令行工具，封装各种编程agent cli或其他工具，比如geminicli/codex/qwen/codebuddy/pi/opencode 等，这些大厂开发的工具本身就具有极高的使用价值和不错的免费额度, 本工具的目标是，将这些工具整合起来，提供一个统一的cli接口，方便用户使用, 并提供: AI确定性工程能力、完全可定制AGENT工作流、全自动开发、AGENT评测、agent工具可观侧性工程等附加特性。
...
- [DAO Roadmap](./docs/ROADMAP.md)
- 工作流
  - [工作流-github工作流](./docs/workflow-github.md)